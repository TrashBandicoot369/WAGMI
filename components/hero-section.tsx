  ...
  return (
    <section className="relative py-10 md:py-16 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold mb-3 leading-tight text-shadow-glow text-white">
            {titleParts[0]}
            {titleParts.length > 1 && (
              <>
                <br />
          ...
          <Link href={ctaLink} className="inline-block">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="px-6 py-2 rounded-lg bg-black/30 backdrop-blur-sm border border-green-400 text-white font-medium 
